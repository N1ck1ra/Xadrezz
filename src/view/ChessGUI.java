...
public class ChessGUI extends JFrame {
    ...
    private static final Color LIGHT_SQ = new Color(120, 0, 0);   // verde oliva escuro
    private static final Color DARK_SQ  = Color.WHITE;
    private static final Color HILITE_SELECTED = Color.PINK;
    private static final Color HILITE_LEGAL    = Color.red;
    ...
    private JMenuBar buildMenuBar() {
        ...
        newGameItem.addActionListener(_ -> doNewGame());
        ...
        quitItem.addActionListener(_ -> dispatchEvent(new WindowEvent(this, WindowEvent.WINDOW_CLOSING)));
    ...
    private JPanel buildSideControls() {
        ...
        btnNew.addActionListener(_ -> doNewGame());
        panel.add(btnNew);

        JCheckBox cb = new JCheckBox("PC (Pretas)");
        cb.setSelected(pcAsBlack.isSelected());
        cb.addActionListener(_ -> pcAsBlack.setSelected(cb.isSelected()));
        panel.add(cb);
        ...
        sp.addChangeListener(_ -> depthSpinner.setValue(sp.getValue()));
        panel.add(sp);
